...
export class CommonToast {
  ...
  static readonly COPY_LOUNGE_CODE = new ToastOptions('게임방 코드가 복사되었습니다.', 'success', 2000);
  static readonly INVALID_GAME_ID = new ToastOptions('유효하지 않은 코드거나 게임이 다릅니다.', 'error', 2000);
